/**
 * Few-shot 模板 - 聊天格式篇：FewShotChatMessagePromptTemplate
 * 
 * 聊天格式的少样本模板，示例中的 input/output 分别映射为 human/ai 消息角色。
 * 相比 FewShotPromptTemplate 更适合 Chat Model（区分对话角色）。
 * 
 * @see fewshot-prompt-template.mjs  — 基础版：FewShotPromptTemplate 文本格式
 * @see example-selector2.mjs        — 升级版：SemanticSimilarityExampleSelector 语义筛选
 */
