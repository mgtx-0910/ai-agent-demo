/**
 * 模板 - Partial 篇：.partial() 预填部分变量
 * 
 * 复用 pipeline-prompt-template 的模板，用 .partial() 提前固定 persona + context，
 * 生成一个只暴露 {feedback} 的简化模板。适合上游确定固定参数、下游只关心业务变量的场景。
 * 
 * @see pipeline-prompt-template.mjs — 模板来源：pipelinePrompt
 */
