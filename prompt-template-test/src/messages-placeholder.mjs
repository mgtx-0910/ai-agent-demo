/**
 * 消息占位符 - MessagesPlaceholder：注入对话历史
 * 
 * 使用 MessagesPlaceholder 在 ChatPromptTemplate 中预留一个消息槽位 {history}，
 * 运行时通过 .formatMessages() 动态注入多轮对话历史，实现带上下文的对话。
 * 这是构建多轮对话 Agent 的基础技术。
 * 
 * @see chat-prompt-template.mjs — 对比：不带占位符的基础聊天模板
 */
