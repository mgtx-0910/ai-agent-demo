/**
 * Prompt 模板 - 聊天篇：ChatPromptTemplate 区分角色
 * 
 * ChatPromptTemplate.fromMessages() 构建包含 system / human 等多角色的消息模板。
 * 相比 PromptTemplate 的纯字符串，能更好地控制对话中不同角色的语气和指令。
 * 
 * @see prompt-template1.mjs         — 基础版：PromptTemplate 字符串模板
 * @see chat-prompt-template2.mjs    — 进阶版：SystemMessagePromptTemplate + HumanMessagePromptTemplate
 */
